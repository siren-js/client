...
- `PositiveValidationResult` is now a singleton. Replace `new PositiveValidationResult()` with `PositiveValidationResult.getInstance()`.`
...
[0.9.0]: https://github.com/siren-js/client/compare/v0.8.2...v0.9.0
